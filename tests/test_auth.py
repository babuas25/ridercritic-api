...
def test_login_invalid_credentials(mock_firebase_service):
    # Mock failed login
    mock_firebase_service.return_value.verify_id_token.side_effect = Exception("Invalid credentials")
...
def test_protected_route_invalid_token(mock_firebase_service):
    ...
    mock_firebase_service.return_value.verify_id_token.side_effect = Exception("Invalid token")
